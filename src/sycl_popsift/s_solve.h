...
inline bool solve(float i[3][3], sycl::vec<float, 3>& b)
{
    ...
    // no __frcp_rn equivalent in sycl so using division version
    float rsd = 1.0 / det;
...
__device__ inline bool solve(float A[3][3], float3& B)
{
